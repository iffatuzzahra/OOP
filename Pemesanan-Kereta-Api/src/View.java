...
public class View extends JFrame {
    ...
    JLabel lLabel = new JLabel("Halo Kereta Api....");
    ...
    public JFrame mainView() {
        ...
        add(lLabel); lLabel.setBounds(180,270,800,100);
        lLabel.setFont(new Font("Times New Roman", Font.PLAIN, 42));
    ...
    public JFrame keretaView() {
        ...
        setLayout(null);
        setPreferredSize(dMain);
        setTitle("Kereta Halo Kereta Api....");
        //setSize(dMain);
    ...
    public JFrame tiketView() {
        ...
        setLayout(null);
        setPreferredSize(dMain);
        setTitle("Tiket Halo Kereta Api....");
    ...
    public JFrame editView() {
        ...
        setLayout(null);
        setPreferredSize(dMain);
        setTitle("Edit Kereta Halo Kereta Api....");
